...
function SocialLink({ icon: Icon, ...props }: NextLinkProps) {
  return (
    <Link {...props} className="group -m-1 p-1">
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:gap-y-12 lg:grid-rows-[auto-1fr]">
        <div className="lg:pl-20 flex justify-center">
          <div className="max-w-xs px-2.5 lg:max-w-none">
            <Image
              src="https://media.licdn.com/dms/image/C4D03AQHSeigt9UG08A/profile-displayphoto-shrink_800_800/0/1570522302858?e=1709164800&v=beta&t=Mc-8TPa6-W0mgHfK1HQk8QdgSuPeYOwkMzjIQiEJ-9Y"
              alt="Julio Zittei"
              width={800}
              height={800}
              quality={95}
        ...
        <div className="lg:order-1 lg:row-span-2 text-center md:text-start">
          ...
          <div className="mt-6 flex justify-center md:justify-start gap-6">
            <SocialLink
              href="https://instagram.com/juliozittei"
              target="_blank"
              icon={InstagramIcon}
            />

            <SocialLink
              href="https://github.com/juliozittei"
              target="_blank"
              icon={GitHubIcon}
            />

            <SocialLink
              href="https://linkedin.com/in/juliozittei"
              target="_blank"
              icon={LinkedInIcon}
            />

            <SocialLink
              href="https://x.com/juliozittei"
              target="_blank"
              icon={TwitterIcon}
            />
          </div>
